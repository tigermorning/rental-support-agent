...
CASES = [
    ...
    ("원문 '둘 이상'을 '두 건'으로 (E-018 실제 오탐)", s("get_listing_rules"),
     "같은 집이라면 두 건을 함께 올리시면 안 됩니다.", False, True, "문의"),
    ("원문 '둘 이상'이 있어도 3건은 잡음", s("get_listing_rules"),
     "같은 집은 3건까지 올릴 수 있습니다.", False, False, "문의"),
