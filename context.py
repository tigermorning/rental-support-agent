...
TOOL_DESCRIPTIONS = {
    ...
    "get_account_rules": "약관 변경 공지, 회원가입 조건(연령·역할 선택), 계정 도용 통지 의무, 탈퇴 요청, 개인정보 열람·정정·삭제·처리정지 요구 방법. "
                         "약관 5조는 로그인 링크·탈퇴 시 파기를 한 줄씩만 언급한다 — "
                         "탈퇴 후 무엇이 얼마나 남는지는 get_data_handling, 인증·보안 방식의 상세는 get_privacy_safeguards",
    "get_data_handling": "개인정보 처리 목적, 수집 항목과 수집하지 않는 정보(고유식별정보 포함), "
                         "항목별 보유 기간(회원 정보·매물·재정정보·메시지·신고 기록·접속 기록), 탈퇴 후 남는 정보, 파기 절차와 기한",
    "get_privacy_safeguards": "임대인·임차인 사이 정보 공개 범위와 제3자 제공, 처리 위탁(수탁자·서버 위치), "
                              "안전성 확보조치(접근 통제·연락처 비공개·암호화·접속기록·비밀번호 미사용·미보관), "
                              "보호책임자, 유출 시 통지·신고, 구제 기관, 방침 변경",
