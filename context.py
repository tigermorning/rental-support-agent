...
TOOL_DESCRIPTIONS = {
    ...
    "get_account_rules": "약관 변경 공지, 회원가입 조건(연령·역할 선택), 이메일 로그인 링크 방식, 계정 도용 통지 의무, 탈퇴 요청, "
                         "개인정보 열람·정정·삭제·처리정지 요구 방법. "
                         "함께 볼 곳: 탈퇴 후 남는 정보·보유 기간은 get_data_handling, 비밀번호 저장 등 보안 조치는 get_privacy_safeguards",
